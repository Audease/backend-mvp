...
export class PopulatePermissions1722624589882 implements MigrationInterface {
...
('assign_role', 'Permission to assign roles to users');
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            DELETE FROM permissions WHERE name IN ('create_user', 'update_user', 'delete_user', 'read_roles', 'assign_role
        `);
  }
}
